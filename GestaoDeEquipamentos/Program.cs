...
namespace GestaoDeEquipamentos {
    ...
    internal class Program {
        ...
        static ArrayList dataFabricacao = new ArrayList() { "Data de Fabricação", "23/09/1999", "01/05/2018", "07/10/2015", "24/10/2022", "01/01/1998" };
        ...
        static void RegistrarEquip() {
            ...
            while (nome.Length < 5) {
                Console.Write("O nome deve ter no mínimo 5 caracteres, digite novamente: ");
        ...
        static void RegistrarChamado() {
            ImprimirEquip();
            Console.Write("Informe o indíce do equipamento do chamado: ");
            ...
            Console.Write("Informe a data de abertura do chamado: ");
        ...
        static void EditarChamado() {
            EscreverChamado();
            Console.Write("Informe o indíce do chamado a ser Editado:");
            int indice = int.Parse(Console.ReadLine());
            ImprimirEquip();
            Console.Write("\nInforme o indíce do equipamento do chamado: ");
            int equipamento = int.Parse(Console.ReadLine());
        ...
        static void ExcluirChamado() {
            EscreverChamado();
            Console.Write("Informe o indíce do chamado a ser Excluído:");
            int indice = int.Parse(Console.ReadLine());
